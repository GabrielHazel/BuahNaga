...
model = load_model(r"D:\perkuliahan\semester 5\PMDPM\Pertemuan 12\Tugas6_A_11906\model_mobilenet.h5")
...
# Streamlit UI
st.title("Prediksi Kematangan Buah Naga - 1906")  # 4 digit npm terakhir
